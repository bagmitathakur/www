...
function setup() {
  ...
  polygonObj=Bodies.circle(50,200,20,polygon_options);
  ...
  slingshot=new SlingShot(polygonObj.body,{x:50,y:200});
...
function draw() {
  ...
  rectMode(CENTER);
  rect(polygonObj.position.x,polygonObj.position.y,30,30);
...
function keyPressed(){
if(keyCode===32){
  Matter.Body.setPosition(polygonObj.body,{x:50,y:200});
